  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="text-sm py-4 px-6">
        <Link href="/">Home</Link> {">"} <Link href="/destinations">Destinations</Link> {">"} Kodaikanal
      </nav>
      ...
      <header className="relative h-[500px] w-full">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <h1 className="text-6xl font-bold text-white">Kodaikanal</h1>
        </div>
      </header>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12 text-center text-xl leading-relaxed">
        <p>
          Kodaikanal, known as the "Princess of Hill Stations," offers misty mountains, scenic lakes, and lush forests. 
          Whether you're taking a boat ride on Kodaikanal Lake, trekking through pine forests, or enjoying the local homemade chocolates, 
          this charming town provides a refreshing retreat.
        </p>
      </section>
