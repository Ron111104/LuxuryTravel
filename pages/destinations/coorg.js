  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="text-sm py-4 px-6">
        <Link href="/">Home</Link> {">"} <Link href="/destinations">Destinations</Link> {">"} Coorg
      </nav>

      {/* Hero Section */}
      <header className="relative h-[500px] w-full">
        <Image
          src="/images/coorg.jpg" // Updated image source for Coorg
          alt="Coorg"
          layout="fill"
          objectFit="cover"
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <h1 className="text-6xl font-bold text-white">Coorg</h1>
        </div>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        {/* Destination Title */}
        <h1 className="text-4xl font-bold text-center mb-6">Coorg</h1>

        {/* Description (Increased Font Size) */}
        <section className="text-xl leading-relaxed text-center mb-12">
          <p>
            Coorg, also known as Kodagu, is a beautiful hill station in Karnataka, famous for its coffee plantations, 
            mist-covered hills, and lush greenery. From scenic waterfalls to rich wildlife and trekking trails, 
            Coorg offers a perfect blend of adventure and tranquility.
          </p>
        </section>
