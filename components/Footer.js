      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-bold mb-2 hover:text-gray-300 transition">LuxuryTravel</h3>
            <p className="text-xs text-center max-w-xs">
              Luxury travel. Exclusive experiences. Custom journeys around India and beyond.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0 text-xs text-center">
              <li>
              ...
              <li>
                <a href="/private-rentals" className="hover:underline">
                  Private Rentals
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 text-center text-xs">
          © {new Date().getFullYear()} LuxuryTravel. All rights reserved.
        </div>
      </div>
    </footer>
  );
